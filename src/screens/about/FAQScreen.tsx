...
const FAQ_ITEMS = [
  {
    question: 'How do Bill Glass Behind the Walls prison events work?',
    answer: 'Read all about what you can expect on our events by clicking here.',
  },
  {
    question: 'Who can participate on a Bill Glass Behind the Walls event?',
    answer:
      'Bill Glass Ministries strives to make serving under the Bill Glass Behind the Walls banner as open and available as possible. Anyone who agrees with our Statement of Faith and meets age requirements can serve on a Bill Glass Behind the Walls event! For more details, click here to visit the Service Opportunities page.',
  },
  {
    question: 'How do I bring Bill Glass Behind the Walls to my area?',
    answer:
      'We rely on local community support to raise people and funds for events. Not only do we need people to serve inside prisons and jails, but we also need volunteers in other areas such as hospitality, transportation, and tech support. We also need intercessory prayer warriors, experienced fundraisers, and more! To start a Local Team in your area (or join one that might already be in place), please click here and fill out the Local Team form or contact the home office at 972.298.1101.',
  },
  {
    question: 'How do I register for an event?',
    answer:
      'Click here for instructions on how to register for an event. If you have any issues, please call the National Support Center at 972.298.1101.',
  },
  {
    question: 'Do I need to create an account to register for an event?',
    answer:
      'You do not need to create an account to register for an event. If you would like to access your account info and see your activity from previous events, you can create a portal account by clicking Sign In at the top of the page then clicking the Sign Up bottom on the login page. Instructions on how to create a portal account, click here.',
  },
  {
    question: "I'm a First Team member. Why am I being charged a registration fee?",
    answer:
      'In order to take advantage of your First Team registration waiver, you will need to login to your portal account before registering for an event. To sign in to your account, click Sign In below and to the right of the event header on the registration page. If you have not created a portal account, click here for instructions on how to do so.',
  },
  {
    question: 'How do I fill out an electronic form if one is needed?',
    answer:
      'Some facilities will require additional security forms while other do not. Many of the forms can be filled out online while others require you to download and complete by hand. Check the Important Information section for the event for a link and instructions. You will also receive an email with access to the form.',
  },
  {
    question: 'Is it safe to go into correctional facilities?',
    answer:
      `In over 50 years of ministry, we've never had an incident that compromised the safety of one of our Teammates. Safety is of the utmost concern to correctional facilities and BGBTW. Facility security is tight with many restrictions, and we insist on everyone being properly trained and observing our "Do's and Don'ts." Facilities often have additional personnel on duty during our visits to provide an extra margin of safety.`,
  },
  {
    question: 'How can I prepare myself for this type of ministry?',
    answer:
      'There are many ways to get ready to go behind the walls! Pray for the event, the offenders you\'ll visit, and for the Lord to prepare hearts to receive His message. Study the BGBTW Equipping materials and training videos on the Equipping Volunteers page and attend the Equip & Ignite training session. Relax and be yourself. And remember that you are not responsible for the results, but rather to just deliver the message.',
  },
  {
    question: 'What can I wear inside the prison?',
    answer:
      'Clothing restrictions vary by facility, but in general you should wear:\n\n• Comfortable, close-toed shoes\n• Casual, modest, and comfortable street clothes that are weather appropriate\n• Do NOT wear shirts with religious logos or inappropriate messages\n• Little or no jewelry\n\nMore details regarding clothing can be found in the "Teammate Do\'s and Don\'ts." Facility specific clothing restrictions will be posted on the website event page, in the email you will receive before the event, and reviewed/updated at the Equip & Ignite meeting.',
  },
  {
    question: 'What am I required/allowed to take into the prison units?',
    answer:
  ...
  {
    question: "What about meals while I'm inside the prison?",
    answer:
  ...
  {
    question: 'Why do you need all of my personal information to go on one of your events?',
    answer:
      "To volunteer with the prison system, a criminal background check must be run first. We are required to provide date of birth (DOB), driver's license (DL) number, and in some states the full social security number of all volunteers and staff.",
  },
  {
    question: 'Why is the registration deadline several weeks from the actual event date?',
    answer:
  ...
  {
    question: `Since BGBTW programs are Christ-centered, why aren't they held in the chapel?`,
    answer:
  ...
  {
    question: 'How much time will I actually get to spend with the inmates?',
    answer:
      'The amount of individual time with inmates varies. Multiple factors are involved:\n\n• Facility visitation restrictions\n• Type of inmate population\n• Approval to eat with the inmates\n• Program times',
  },
  {
    question: 'Am I allowed to witness to the prison officials?',
    answer:
  ...
  {
    question: 'Are Equip & Ignite sessions and other scheduled meetings mandatory?',
    answer:
  ...
  {
    question: "If I've already been on an event, do I still have to come to training?",
    answer:
      "YES! Every registered Teammate needs to attend Equip & Ignite training. We provide as much information as possible about our events in advance; however, circumstances and situations inside correctional facilities can often change even on the day of the event. E&I training is where you will receive the most accurate information about the facility you're assigned to, requirements to enter, program times and changes, and other very important information.",
  },
  {
    question: 'How long will I be in the facility?',
    answer: 'On average, you can expect to be in the facility 7-8 hours on the day of the event; however, it can vary.',
  },
  {
    question: 'Why does Bill Glass Behind the Walls charge a registration fee?',
    answer:
      'The ministry charges a nominal registration fee to help cover the costs of the event materials and training. The fee is non-refundable except in instances when an event is cancelled or one is denied entry to a facility. If access is denied, you are then given the option to donate the fee to the ministry or have it refunded. If the fee is donated, you will be provided a charitable gift receipt for tax deduction purposes. Registration fees for qualifying First Team members and their spouses are waived for all Weekend and Day of Champion events.',
  },
  {
    question: "What if I can't afford to pay the registration fee?",
    answer:
  ...
  {
    question: 'What is $75 to Life?',
    answer:
      'On average, seeing one decision for Christ will cost Bill Glass Behind the Walls about $75. The ministry calls this $75 TO LIFE. That $75 investment represents even more than one soul saved, it also represents:\n\n• One person evangelistically trained and sent to share the gospel Behind the Walls\n• Many inmates hear the gospel, even if they do not accept Christ that day\n• Many fallen-away believers repent of their sins and come back to the Lord\n• Incarcerated believers trained to share with other inmates and their families and friends\n• Newly trained evangelists coming back to their communities ready to share the gospel with others\n\nFor more information or to give, go to the $75 to Life page',
  },
];
